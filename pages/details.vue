      ...
      <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <div class="space-y-6">
            ...
            <div>
              <h2
                class="grow font-semibold text-slate-800 dark:text-slate-100 truncate mb-4"
              >
                To Do's 🖋️
              </h2>
              <div class="space-y-2">
                ...
                >
                  <div class="sm:flex sm:justify-between sm:items-start">
                    ...
                    <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                      <div class="flex items-center">
                        ...
                        <button class="cursor-move mr-2">
                          ...
                          <svg
                            class="w-3 h-3 fill-slate-300 dark:fill-slate-600"
                            viexBox="0 0 12 12"
                        ...
                        <label class="flex items-center">
                          ...
                          />
                          <span
                            class="font-medium text-slate-800 dark:text-slate-100 peer-checked:line-through ml-2"
                    ...
                    <div class="flex items-center justify-end space-x-3">
                      ...
                      <!-- Attach button -->
                      <button
                        class="text-slate-400 dark:text-slate-500 hover:text-indigo-500 dark:hover:text-indigo-500"
                      >
                        <svg
                          class="w-4 h-4 shrink-0 fill-current mr-1.5"
                          viewBox="0 0 16 16"
                      ...
                      <ul class="pl-12 space-y-3">
                        <li>
                          <label class="flex items-center">
                            ...
                            />
                            <span
                              class="text-sm text-slate-800 dark:text-slate-100 peer-checked:line-through ml-3"
            ...
            <div>
              ...
              <div class="space-y-2">
                <!-- Task -->
                <div
                  class="bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700 p-4 opacity-60"
                  draggable="true"
                >
                  <div class="sm:flex sm:justify-between sm:items-start">
                    <!-- Left side -->
