      ...
      <div class="overflow-x-auto">
        <table class="table-auto w-full dark:text-slate-300">
          ...
          >
            <tr>
              <th class="p-2">
                <div class="font-semibold text-left">Contribution</div>
              </th>
              <th class="p-2">
                <div class="font-semibold text-center">Contributor</div>
              </th>
              <th class="p-2">
                <div class="font-semibold text-center">Stat</div>
              </th>
            </tr>
          </thead>
          <!-- Table body -->
          ...
          >
            ...
            <tr>
              ...
              <td class="p-2">
                <div class="text-center">Steven Walker</div>
              </td>
            ...
            <tr>
              ...
              <td class="p-2">
                <div class="text-center">Peter Stefanov</div>
              </td>
            ...
            <tr>
              ...
              <td class="p-2">
                <div class="text-center">Team Z</div>
              </td>
            ...
            <tr>
              ...
              <td class="p-2">
                <div class="text-center">Team C</div>
              </td>
            ...
            <tr>
              ...
              <td class="p-2">
                <div class="text-center">Team A</div>
              </td>
