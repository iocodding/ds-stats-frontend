  ...
  <tbody class="text-sm">
    ...
    <tr>
      ...
      <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <div class="text-left font-medium">
          <div
            class="text-xs inline-flex font-medium bg-rose-100 dark:bg-rose-500/30 text-rose-500 dark:text-rose-400 rounded-full text-center px-2.5 py-1"
          >
            {{ order.status.todo }}
          </div>
          /
          <div
            class="text-xs inline-flex font-medium bg-amber-100 dark:bg-amber-400/30 text-amber-600 dark:text-amber-400 rounded-full text-center px-2.5 py-1"
          >
    ...
    >
      <td colspan="10" class="px-2 first:pl-5 last:pr-5 py-3">
        <div
          class="flex items-center bg-slate-50 dark:bg-slate-900/30 dark:text-slate-400 p-3 -mt-3"
        >
          <div class="flex flex-col gap-4">
            <div class="flex gap-4">
              <strong>Variants:</strong>
              <div class="flex gap-2">
                <DssBadge text="Primary" color="success" />
                <DssBadge text="Secondary" color="success" />
                <DssBadge text="Tertiary" color="success" />
              </div>
            </div>
            <div class="flex gap-4">
              <strong>Sizes:</strong>
              <div class="flex gap-2">
                <DssBadge text="x-small" color="danger" />

                <DssOptionsMenu>
                  <template #activator>
                    <DssBadge text="x-large" color="warning" />
                  </template>
                  <DssOptionsMenuItem>
...
export default {
  ...
  setup(props, context) {
    ...
    const typeIcon = (type) => {
      switch (type) {
        case "Subscription":
          return `<svg class="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 shrink-0 mr-2" viewBox="0 0 16 16">
