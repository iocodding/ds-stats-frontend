          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li v-for="component in components">
                <router-link
                  class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:dark:bg-indigo-500/30 rounded group"
                  to="#0"
                  @click="$emit('close-modal')"
                >
                  <DssIconFigma class="w-5 h-5 mr-2" />
...
<script setup>
const components = [
  { name: "Component - DssButton" },
  { name: "Component - DssAlert" },
  { name: "Component - DssButton" },
];

const features = [{ name: "Customer Dialog" }, { name: "Customer Table" }];
</script>
