          ...
          <header>
            <div class="flex mb-2">
              ...
              >
                ...
                <img
                  class="rounded-full"
                  src="https://img001.prntscr.com/file/img001/ib0OL55ySsiJ5M_Z3HUv3w.png"
                  width="64"
                  height="64"
                  :alt="item.name"
                />
      ...
      <div class="border-t border-slate-200 dark:border-slate-700">
        <div class="flex divide-x divide-slate-200 dark:divide-slate-700">
          ...
          >
            <div class="flex items-center justify-center">
              <svg
                class="w-4 h-4 fill-current text-slate-400 dark:text-slate-600 group-hover:text-slate-500 shrink-0 mr-2"
                viewBox="0 0 16 16"
              >
                <path
